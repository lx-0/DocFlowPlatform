...
> **Note:** Analytics & Reporting features are being implemented as part of M5. The `/admin/analytics` dashboard and related export/retention settings will be available when that milestone ships. This guide describes the intended behaviour.
